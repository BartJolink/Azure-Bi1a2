...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="#informatie" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Informatie</a>
    <a href="#overzicht" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Overzicht</a>
    <a href="#tabel" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Tabel</a>
    <a href="#parameters" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Parameters van blast</a>
    <a href="#blasten" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Zelf blasten</a>
  </div>
</nav>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="informatie" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"><b>Informatie</b></h1>
    <hr style="width:50px;border:5px solid red" class="w3-round">
      <p> Hieronder is een tabel met verschillende linkjes met informatie over champignons en over de compost van champignons.
  ...
  <!-- Overzicht -->
  <div class="w3-container" id="overzicht" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"><b>Overzicht</b></h1>
    <hr style="width:50px;border:5px solid red" class="w3-round">
    <p>Hier onder is een pie charm weergegeven over de 10 meest voorkomende organismen in de database die is opgezet.
        De database bevat de resultaten van het onderzoek. (meer over het onderzoek bij kopje 'Tabel')</p>
  </div>
    <head>
...
<div id="chartContainer" style="height: 500px; width: 75%;"></div>
  ...
  <div class="w3-container" id="tabel" style="margin-top:75px">
    ...
    <hr style="width:50px;border:5px solid red" class="w3-round">
    <p>Hier onder is een tabel weergegeven (als je filtert of zoekt op een zoekwoord). In deze tabel staan de resultaten na het onderzoek met behulp van blasten. </p>
      <p><b>Het onderzoek: </b></p>
    <p>Er is DNA geïsoleerd uit de compost van de champions, deze DNA sequenties zijn in groot excel bestand gezet.
        De sequenties uit dat bestand zijn geblast met behulp van de tool blast (zie kopje parameters of informatie voor meer informatie over blast).
        De resultaten uit de blast zijn opgeslagen in een database, die je hieronder kunt bevragen door te filteren en door op een zoekwoord te zoeken.
  ...
  <div class="w3-container" id="parameters" style="margin-top:75px">
    ...
    <hr style="width:50px;border:5px solid red" class="w3-round">
      ...
      <ul class="w3-ul w3-light-grey w3-center">
        ...
        <li class="w3-padding-16"><a href = 'https://blast.ncbi.nlm.nih.gov/Blast.cgi?PROGRAM=blastx&PAGE_TYPE=BlastSearch&LINK_LOC=blasthome'> Blast</a></li>
        <li class="w3-padding-16">De cut-off stond op een e-value van 1e-3.</li>
       </ul>
      <p> Ook is er een cut off ingesteld op een e-value van 3e AANPASSEN!!!!!!. </p>
      </div>
...
<!-- Blasten -->
  <div class="w3-container" id="blasten" style="margin-top:75px">
    ...
    <hr style="width:50px;border:5px solid red" class="w3-round">
      <p> Hier onder kunt u zelf een Sequentie invoeren die vervolgens geblast wordt.</p>
      <form method="GET">
...
<!-- W3.CSS Container -->
<div class="w3-light-grey w3-container w3-padding-32" style="margin-top:75px;padding-right:58px"><p class="w3-right">Gemaakt door: Bart Jolink, Wouter Gaykema, Erik Verweij en Maite van den Noort</p></div>
